...
public class LatestExchangeRatesTest extends AbstractDbTest {
    ...
    @Test
    public void should_return_error_if_rate_is_not_found() {
        ExchangeRateProvider m = db.getLatestRates();
        ExchangeRate rate = m.getRate(c1, c2);
    ...
    @Test
    public void should_calculate_accounts_total_in_home_currency() {
    ...
    @Test
    public void should_calculate_accounts_total_in_every_currency() {
    ...
    @Test
    public void should_calculate_accounts_total_correctly_with_big_amounts() {
