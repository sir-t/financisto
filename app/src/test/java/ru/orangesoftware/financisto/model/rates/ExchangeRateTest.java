...
public class ExchangeRateTest extends AbstractDbTest {
    ...
    @Test
    public void should_reset_time_to_midnight() {
    ...
    @Test
    public void should_insert_currency_rate_for_both_sides() {
    ...
    @Test
    public void should_update_existing_rate() {
        RateBuilder.withDb(db).from(c1).to(c2).at(DateTime.date(2012, 1, 17)).rate(0.78592f).create();
        assertEquals(0.78592f, db.findRate(c1, c2, DateTime.date(2012, 1, 17).asLong()).rate, 0.00001f);
        assertEquals(1.27239f, db.findRate(c2, c1, DateTime.date(2012, 1, 17).asLong()).rate, 0.00001f);
    ...
    @Test
    public void should_save_multiple_rates() {
        RateBuilder.withDb(db).from(c1).to(c2).at(DateTime.date(2012, 1, 17)).rate(0.78592f).create();
    ...
    @Test
    public void should_delete_rate() {
    ...
    @Test
    public void should_replace_rate() {
        RateBuilder.withDb(db).from(c1).to(c2).at(DateTime.date(2012, 1, 17)).rate(0.78592f).create();
    ...
    @Test
    public void should_save_downloaded_rates() {
        //given
