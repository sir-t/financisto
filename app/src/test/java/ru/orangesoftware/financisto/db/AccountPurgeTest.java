...
public class AccountPurgeTest extends AbstractDbTest {
    ...
    public void setUp() throws Exception {
        ...
        * 21/05 A1 +10          |  10  |
        * */
        TransactionBuilder.withDb(db).dateTime(DateTime.date(2012, 5, 29)).account(a1).amount(10).create();
        TransactionBuilder.withDb(db).dateTime(DateTime.date(2012, 5, 28)).account(a1).amount(-20).create();
        TransferBuilder.withDb(db).dateTime(DateTime.date(2012, 5, 27))
                .fromAccount(a1).fromAmount(-100)
                .toAccount(a2).toAmount(20).create();
        TransactionBuilder.withDb(db).dateTime(DateTime.date(2012, 5, 26)).account(a1).amount(100).create();
        TransferBuilder.withDb(db).dateTime(DateTime.date(2012, 5, 25))
                .fromAccount(a2).fromAmount(-50)
                .toAccount(a1).toAmount(10).create();
        TransactionBuilder.withDb(db).dateTime(DateTime.date(2012, 5, 24)).account(a1).amount(200).create();
        TransactionBuilder.withDb(db).dateTime(DateTime.date(2012, 5, 24)).account(a2).amount(-20).create();
        TransactionBuilder.withDb(db).dateTime(DateTime.date(2012, 5, 23)).account(a1).amount(-150)
                .withSplit(categoriesMap.get("A1"), -100)
                .withTransferSplit(a2, -50, 10)
                .create();
        TransactionBuilder.withDb(db).dateTime(DateTime.date(2012, 5, 22)).account(a1).amount(-20).create();
        TransactionBuilder.withDb(db).dateTime(DateTime.date(2012, 5, 21)).account(a1).amount(10).create();
    }
    ...
    public void should_purge_transactions_older_than_specified_date() {
        ...
        assertOldestTransaction(a1, DateTime.date(2012, 5, 21), 10);
        assertAccountBlotter(a1, 10, -20, -100, 100, 10, 200, -150, -20, 10);
        assertAccountRunningBalance(a1, 40, 30, 50, 150, 50, 40, -160, -10, 10);
        assertAccountBlotter(a2, 20, -50, -20, 10);
        assertAccountRunningBalance(a2, -40, -60, -10, 10);
        ...
        db.purgeAccountAtDate(a1, DateTime.date(2012, 5, 20).asLong());
        assertOldestTransaction(a1, DateTime.date(2012, 5, 21), 10);
        assertAccountBlotter(a1, 10, -20, -100, 100, 10, 200, -150, -20, 10);
        assertAccountRunningBalance(a1, 40, 30, 50, 150, 50, 40, -160, -10, 10);
        assertAccountBlotter(a2, 20, -50, -20, 10);
        ...
        db.purgeAccountAtDate(a1, DateTime.date(2012, 5, 21).asLong());
        assertOldestTransaction(a1, DateTime.date(2012, 5, 21).atDayEnd(), 10);
        assertAccountBlotter(a1, 10, -20, -100, 100, 10, 200, -150, -20, 10);
        assertAccountRunningBalance(a1, 40, 30, 50, 150, 50, 40, -160, -10, 10);
        assertAccountBlotter(a2, 20, -50, -20, 10);
        assertAccountRunningBalance(a2, -40, -60, -10, 10);
        ...
        db.purgeAccountAtDate(a1, DateTime.date(2012, 5, 22).asLong());
        assertArchiveTransaction(a1, DateTime.date(2012, 5, 22).atDayEnd(), -10);
        ...
        db.purgeAccountAtDate(a1, DateTime.date(2012, 5, 23).asLong());
        assertArchiveTransaction(a1, DateTime.date(2012, 5, 23).atDayEnd(), -160);
        ...
        db.purgeAccountAtDate(a1, DateTime.date(2012, 5, 24).asLong());
        assertArchiveTransaction(a1, DateTime.date(2012, 5, 24).atDayEnd(), 40);
        ...
        db.purgeAccountAtDate(a1, DateTime.date(2012, 5, 27).asLong());
        assertArchiveTransaction(a1, DateTime.date(2012, 5, 27).atDayEnd(), 50);
        ...
        assertAccounts();
        //when everything
        db.purgeAccountAtDate(a1, DateTime.date(2012, 5, 29).asLong());
        assertArchiveTransaction(a1, DateTime.date(2012, 5, 29).atDayEnd(), 40);
