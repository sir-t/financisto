...
public class AccountBlotterTest extends AbstractDbTest {
    ...
    public void should_include_transfer_splits_into_blotter_for_account() {
        ...
        TransactionBuilder.withDb(db).dateTime(DateTime.date(2012, 2, 8)).account(a1).amount(1000).create();
        TransactionBuilder.withDb(db).dateTime(DateTime.date(2012, 2, 8)).account(a2).amount(200).create();
        assertAccountBlotter(a1, 1000);
        assertAccountBlotter(a2, 200);
        assertAccountBlotterTotal(a1, DateTime.date(2012, 2, 1), DateTime.date(2012, 2, 7), 0);
        assertAccountBlotterTotal(a1, DateTime.date(2012, 2, 1), DateTime.date(2012, 2, 8), 1000);
        assertAccountBlotterTotal(a2, DateTime.date(2012, 2, 8), DateTime.date(2012, 2, 9), 200);

        // regular transfer
        TransferBuilder.withDb(db).dateTime(DateTime.date(2012, 2, 9)).fromAccount(a1).fromAmount(-100).toAccount(a2).toAmount(50).create();
        assertAccountBlotter(a1, -100, 1000);
        assertAccountBlotter(a2, 50, 200);
        assertAccountBlotterTotal(a1, DateTime.date(2012, 2, 1), DateTime.date(2012, 2, 9), 900);
        assertAccountBlotterTotal(a2, DateTime.date(2012, 2, 8), DateTime.date(2012, 2, 9), 250);

        // regular split
        TransactionBuilder.withDb(db).dateTime(DateTime.date(2012, 2, 10)).account(a1).amount(-500)
                .withSplit(categoriesMap.get("A1"), -200)
                .withSplit(categoriesMap.get("A1"), -300)
                .create();
        assertAccountBlotter(a1, -500, -100, 1000);
        assertAccountBlotter(a2, 50, 200);
        assertAccountBlotterTotal(a1, DateTime.date(2012, 2, 1), DateTime.date(2012, 2, 10), 400);
        assertAccountBlotterTotal(a1, DateTime.date(2012, 2, 9), DateTime.date(2012, 2, 10), -600);
        assertAccountBlotterTotal(a2, DateTime.date(2012, 2, 1), DateTime.date(2012, 2, 9), 250);

        // transfer split
        TransactionBuilder.withDb(db).dateTime(DateTime.date(2012, 2, 11)).account(a2).amount(-120)
        ...
        assertAccountBlotterTotal(a1, DateTime.date(2012, 2, 1), DateTime.date(2012, 2, 12), 600);
        assertAccountBlotterTotal(a2, DateTime.date(2012, 2, 1), DateTime.date(2012, 2, 12), 130);
    }
